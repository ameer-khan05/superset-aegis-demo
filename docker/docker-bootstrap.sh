...
if [ "$CYPRESS_CONFIG" == "true" ]; then
    ...
    export SUPERSET__SQLALCHEMY_DATABASE_URI=postgresql+psycopg2://${DATABASE_USER:-superset}:${DATABASE_PASSWORD:-superset}@${DATABASE_HOST:-db}:${DATABASE_PORT:-5432}/superset_cypress
    PORT=8081
fi
